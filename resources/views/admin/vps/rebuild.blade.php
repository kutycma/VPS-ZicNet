        ...
        <div class="card" style="border-radius:16px;">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    Việc cài lại hệ điều hành sẽ <b>XÓA TOÀN BỘ DỮ LIỆU</b> hiện có trên VPS của tài khoản này! Cẩn thận với thao tác này!
                </div>

                <form action="{{ route('admin.vps.rebuild', $instance) }}" method="POST">
                    @csrf
                    ...
                    <div class="text-center mt-4 pt-3 border-top">
                        <a href="{{ route('admin.vps.show', $instance) }}" class="btn btn-secondary btn-lg mr-2" style="border-radius:10px;"><i class="fas fa-arrow-left mr-2"></i>Quay lại</a>
                        <button type="submit" class="btn btn-danger btn-lg" style="border-radius:10px;" onclick="return confirm('BẠN CHẮC CHẮN MUỐN XÓA TOÀN BỘ DỮ LIỆU VÀ CÀI LẠI VPS CỦA NGƯỜI DÙNG NÀY CHỨ?')"><i class="fas fa-microchip mr-2"></i>Xác nhận Cài lại OS</button>
                    </div>
                </form>
